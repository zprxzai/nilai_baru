...
if (isset($_POST['simpan'])) {
    ...
    if(!file_exists($_FILES['foto']['tmp_name']) || !is_uploaded_file($_FILES['foto']['tmp_name'])) {
        $sql = "INSERT INTO siswa SET nis='$nis', nama='$nama', gender='$gender', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', kelas_id='$kelas_id'";
    } else{
        if(!in_array($akhiran, $ekstensi)) {
            ...
            if ($ukuran < 100000000000) {
                ...
                $sql = "INSERT INTO siswa SET nis='$nis', nama='$nama', gender='$gender', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', kelas_id='$kelas_id', foto='$nmfile'";
            } else {
                // header("location:index.php?m=siswa");
                // echo '<script language="JavaScript">';
